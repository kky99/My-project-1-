...
namespace GooglePlayGames.Editor
{
    ...
    using System.Xml;
    using UnityEditor;
    using UnityEditor.Build;  // 追加：NamedBuildTarget を使うための名前空間
    using UnityEngine;

    /// <summary>
    /// Android向けの Google Play Game Services セットアップダイアログ
    /// </summary>
    public class GPGSAndroidSetupUI : EditorWindow
    {
        /// <summary>
        /// Play Console のリソースデータからの設定情報
        /// </summary>
        ...
        /// <summary>
        /// Play ConsoleからダウンロードしたXMLを使用してセットアップを実行する
        /// </summary>
        ...
        public static void CheckBundleId()
        {
            ...
            // 新しい API を使用：NamedBuildTarget を利用
